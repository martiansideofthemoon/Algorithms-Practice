							...
							int size1,int size2,int &count)
{
	...
	else if (l2_begin==l2_end)
	{
		...
		{
			cout << "XXXXXXXXp1 " << *x << " XXXXXXXX" << endl;
			cout << *l1_begin << endl;
			*new_iter = *l1_begin;
			new_iter++;
			cout << *l1_begin << endl;
			cout << "XXXXXXXXp2 " << *x << " XXXXXXXX" << endl;
			l1_begin++;
			size1--;	
		}
	}
...
int main()
{
	...
	*/
	n=4;
	perm_p.push_back(4);perm_p.push_back(3);perm_p.push_back(2);perm_p.push_back(1);
	perm_q.push_back(4);perm_q.push_back(3);perm_q.push_back(2);perm_q.push_back(1);
